"""gui/config_tabs/environment_tab/environment_common_widgets/relay_assignment_widget.py

Stage 2.6.3 update:
- Promote relay assignment from climate-only widget to environment-common widget.
...
class RelayAssignmentWidget(QGroupBox):
    """Shared SMU relay assignment widget for environment tabs.

    This widget is purely a view-layer component and does not contain any
    environment inference or hardware logic.
    """
    ...
    def _build_ui(self) -> None:
        """Build relay assignment controls."""
