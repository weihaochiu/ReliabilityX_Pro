...
class IndoorEnvironmentTab(QWidget):
    """Indoor environment tab skeleton."""
    ...
    def save_current_instance(self) -> None:
        """Persist indoor instance relay assignment and recipe settings."""
        instance_id = self.get_default_instance_id()
