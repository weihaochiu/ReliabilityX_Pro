"""gui/config_tabs/environment_recipe_editors/indoor_recipe_editor.py

Stage 3.0 skeleton:
- Indoor recipe editor field model only.
...
class IndoorRecipeEditor(BaseEnvironmentRecipeEditor):
    """Editor for indoor environment recipes."""

    environment_type = "indoor"

    def __init__(self, parent=None) -> None:
        """Initialize indoor-specific fields."""
    ...
    def get_recipe_data(self) -> dict:
        """Return full indoor recipe data."""
